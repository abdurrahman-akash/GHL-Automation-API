...
export const syncWebhookContact = async ({ payload, signature }) => {
  ...
  const locationId = contact.locationId || event.locationId;

  if (!locationId) {
    throw new ApiError(400, "locationId is required in webhook payload");
  }
